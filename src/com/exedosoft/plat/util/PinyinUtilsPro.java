...
public class PinyinUtilsPro {
	...
	private  List<String> hpinyin = new ArrayList<String>();
	...
	public static void main(String[] args) {
		...
		String py = pp.getPinyin();
		System.out.println(str + " = " + py);
		
		String headP = pp.getHeadPinyin();
	 ...
	 * @return
	 */
	public  void convertChineseToPinyin(String chinese) {
	...
	private  boolean setValue(String py) {
		pinyin.add(py);

...
public class ImageUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String srcQrCodePath = "D:/showqrcode5.jpg";
		String toQrCodePath = "D:/showqrcode5_1.jpg";

		String srcLogoPath = "D:/logo.jpg";
		String toLogoPath = "D:/logo_1.jpg";

		String toEnd = "D:/end.jpg";
		imageObj.resizeImage(srcQrCodePath, toQrCodePath, 340, 340);// 按指定的长宽重置图形大小
		imageObj.resizeImage(srcLogoPath, toLogoPath, 850, 180);// 按指定的长宽重置图形大小

		imageObj.mergeBothImage(basePath, toQrCodePath, 1056, 636, toEnd); // 按指定坐标合并图片
		imageObj.mergeBothImage(toEnd, toLogoPath, 1479, 80, toEnd); // 按指定坐标合并图片

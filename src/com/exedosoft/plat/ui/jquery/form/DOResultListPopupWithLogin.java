...
public class DOResultListPopupWithLogin extends DOBaseForm {

	public DOResultListPopupWithLogin() {
		super();
	}
	...
	String getPopupForm(DOFormModel fm) {
		...
		if (theValue == null) {
			try {
				data = DOGlobals.getInstance().getSessoinContext().getUser();
			} catch (Exception e) {
		...
		///张龙所加，有bug， 当时可能是解决赋值的问题。
//		function handleInputValueChange(o,e,b){
//			var interid = null;
//			var oldvalue = $.trim(o.value);
//			var newvalue;
//			if(b){
//				console.log('end..');
...
//				.append(" onblur=\"handleInputValueChange(this, event,true)\"")
//				.append(" onfocus=\"handleInputValueChange(this, event)\"")

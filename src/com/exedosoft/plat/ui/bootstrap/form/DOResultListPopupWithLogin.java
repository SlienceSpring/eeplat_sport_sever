...
public class DOResultListPopupWithLogin extends DOValueResultList implements
		DOIViewTemplate {

	private static Log log = LogFactory.getLog(DOResultListPopupWithLogin.class);

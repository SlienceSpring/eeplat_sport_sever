...
public abstract class DOViewTemplate implements DOIViewTemplate {
	...
	public Map<String, Object> putData(DOIModel doimodel) {
		...
		///////////////父面板
		///容易造成问题，不清楚当时加入还这个参数的动机。
//		try {
//			String parentPaneName = DOGlobals.getInstance().getSessoinContext().getFormInstance().getValue("parentPaneName");
//			if(parentPaneName!=null){
//				data.put("parentPaneName", parentPaneName);
//			}
//		} catch (Exception e) {

...
public class GeneUISelectData {
	...
	public void geneConfig() {
		...
		try {
			...
			// }
			//
			// DOMenuModel parentMenu =
			// DOMenuModel.getMenuModelByName(menuName);
			// DOBO boMenu = DOBO.getDOBOByName("DO_UI_MenuModel");
			//
			// if(parentMenu==null){
			// DOMenuModel dmm =
			// DOMenuModel.getMenuModelByName(menuName+"_root");
			// if(dmm!=null){
	...
	private DOPaneModel geneResult(List properties) throws ExedoException {
		 ...
		 * 相关服务生成
		 */
		DOService rService = DOService
				.getService(geneATable + "_auto_criteria");
		/**
		 * 生成表格
		 */

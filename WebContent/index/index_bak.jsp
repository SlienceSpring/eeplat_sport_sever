...
<form name="loginform" id="loginform"  method="post">
	<p>
		...
		<input type="text" name="name" id="name" class="input"  size="20" tabindex="10" value=""/></label>
	</p>
	<p>
		<label><%=I18n.instance().get("Paasword")%></label><br />
		<input type="password" name="password" id="password" class="input"  size="20" tabindex="20" value=""/></label>
	</p>

	<p>
		<label><%=I18n.instance().get("Tenant")%> </label><br />
		<input type="tenancyId" name="tenancyId" id="tenancyId" class="input"  size="20" tabindex="20" value=""/></label>
	</p>
	...
	<p class="forgetmenot">
       ...
       <input type="text" name="randcode"  class="input" style="height:18px; width:60px; border:solid 1px #cadcb2; font-size:12px; color:#81b432;" />
        <div style="float:left">
        	<img src='<%=request.getContextPath()%>/web/default/image.jsp'  height="23px"  style="margin-top:15px" border=0 id="numImg" title="看不清，换一张!" />
        </div>
	...
	<% if ("en".equals(DOGlobals.getValue("lang.local"))){ %>	
		<a align="center" href="/multimanager/exedo/webv3/setup/index_en.jsp">
	<% } else { %>
		<a align="center" href="/multimanager/exedo/webv3/setup/index.jsp">
	<% }%>
	
	<%=I18n.instance().get("SignUp")%></a> &nbsp;&nbsp;&nbsp;&nbsp;
	 <a align="center" href="/multimanager/forgetpwd.pml?isApp=true"><%=I18n.instance().get("ForgetPassword")%></a> <div>

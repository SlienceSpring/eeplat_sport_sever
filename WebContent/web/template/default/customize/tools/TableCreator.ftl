	...
	<table id='g402880242a65aabd012a65aabd0a0000' class='tablesorter' border="0" cellpadding="1" cellspacing="1" >
		<thead>
		  <tr>
            ...
            <th id='col_name'    nowrap='nowrap' align='left'>${i18n('字段名称')} </th> 
            <th id='col_remark'    nowrap='nowrap' align='left'>${i18n('字段备注')} </th> 
            <th id='dbtype'    nowrap='nowrap' align='left'>${i18n('字段类型')} </th> 
            <th id='dbsize'    nowrap='nowrap' align='left'>${i18n('字段长度')} </th> 
		</tr>
		</thead>
		<tbody>
		...
		<tr id="tr0"  style="display:none">
		            ...
		            <td  nowrap='nowrap' align='center' >    <input  style='border:#B3B3B3 1px solid;'  exedo_notnull='NotNull'   onclick="this.style.borderColor='#406B9B'" onmouseover="this.style.borderColor='#99E300'" onmouseout="this.style.borderColor='#A1BCA3'"  type='text' name='col_remark'  title='备注'  size="25"/>  </td>
		   ...
		   <tfoot>
	     	<tr> <td  style="text-align:center;align:center"  colspan="4" >
					...
					$('#3ba35f69a6084e76bfed4c89e41c2f65').bind('click',function(){
					  ...
					  if(funcSBCDot($('#tableName').val())){
					  	alert(EELang.vSBCDOT);
					  	return;
					  }

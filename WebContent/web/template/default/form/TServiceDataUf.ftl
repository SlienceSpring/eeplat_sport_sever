...
<#--参数通过formName传递-->
<button   class="ctlBtn  btn btn-default" type="button"  style="${model.style?if_exists}"   id='${model.objUid}${model.data.uid}' <#compress><@JudgeStyle model/></#compress> >    <#compress><@JudgeBootIcon model/></#compress>  ${model.l10n}</button>
<script>

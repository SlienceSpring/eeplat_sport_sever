...
<#macro JudgeStyle a>
	...
	<#elseif (a.cssClass?exists ) >
		class='${a.cssClass} btn btn-default'   <#compress><@JudgeMobileIcon a/> </#compress>
	...
	<#elseif (a.linkPaneModel?exists && (a.linkPaneModel.cssClass)?exists ) >
		class='${a.linkPaneModel.cssClass} btn btn-default'  <#compress><@JudgeMobileIcon a/> </#compress>
	<#else>

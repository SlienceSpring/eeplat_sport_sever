...
String paneModelName =  request.getParameter("paneModelUid");  response.addHeader("Content-Disposition", "attachment;filename=export.xls");    out.println(DODownLoadFile.outHtmlCode(paneModelUid));%>

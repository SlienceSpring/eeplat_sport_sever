...
function WebFXLoadTree(sText, sXmlSrc, oAction, sBehavior, sIcon, sOpenIcon,baksrc) {
	WebFXTree.call(this, sText, oAction, sBehavior, sIcon, sOpenIcon,baksrc);
...
function WebFXLoadTreeItem(sText, sXmlSrc, oAction, eParent, sIcon, sOpenIcon,baksrc) {
	WebFXTreeItem.call(this, sText, oAction, eParent, sIcon, sOpenIcon,baksrc);
...
WebFXLoadTree.createItemFromElement = function (oNode) {
	...
	var jsNode = new WebFXLoadTreeItem(jsAttrs.html || "", jsAttrs.src, action,
									   null, jsAttrs.icon, jsAttrs.openIcon,jsAttrs.baksrc);
	if (jsAttrs.text) {
...
WebFXLoadTree.documentLoaded = function (jsNode) {
	...
	var oldSuspend = false;
	try{
		oldSuspend = t.getSuspendRedraw();
	}catch(e){

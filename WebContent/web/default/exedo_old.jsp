...
<script type="text/javascript" src="<%=request.getContextPath()%>/web/default/js/jquery-plugin/noty/jquery.noty.packaged.min.js" ></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/web/default/js/jquery-plugin/chosen/chosen.jquery.js" ></script>		
<script type="text/javascript" src="<%=request.getContextPath()%>/web/default/js/jquery-plugin/chosen/chosen.order.jquery.js" ></script>		
...
<body  lang=zh>
<!-- Echarts要放到body里，引入 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/web/default/js/echarts/echarts.js"  ></script>
...
require.config({
    paths: {
        echarts: '<%=request.getContextPath()%>/web/default/js/echarts'
    }
});

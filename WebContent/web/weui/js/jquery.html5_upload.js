    ...
    jQuery.fn.html5_upload = function(options) {
        ...
        function upload() {
            ...
            for(var i = 0; i < total; i++){
            	 ...
            	 var fileExists = ep.globalURL + 'web/default/upload_action_uploadify_exists.jsp?filename=' +  encodeURIComponent(escape(filename));
            ...
            function upload_file(number) {
                ...
                $.each(options.headers,function(key,val){
                    ...
                    xhr.setRequestHeader(key, encodeURIComponent(val));
                });

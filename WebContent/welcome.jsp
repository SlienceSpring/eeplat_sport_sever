			...
			<div class="row">
				<div class="col-md-8 col-xs-12">
					   ...
					   <div class="form-actions">
			            <a href="web/default/"  class="btn btn-primary btn-lg">后端配置登录</a>&nbsp;&nbsp;后端配置登陆的用户名/密码，为创建第一个工程时自己设定的用户名/密码。
			            <br/>	   <br/>
			            <a href="projects/index.jsp"  class="btn btn-primary btn-lg">业务系统登陆</a>&nbsp;&nbsp;业务系统登陆的用户名/密码，缺省为u/1111，可以登录后修改。
			            <br/>	   <br/>
			            <a href="web/mobile/index.jsp"  class="btn btn-primary btn-lg">手机界面登陆</a>&nbsp;&nbsp;和业务系统的用户名/密码相同。
			            <br/>	   <br/>
			            <a   class="btn btn-info btn-lg"  href="javascript:closeWelcomePage()"><i class="glyphicon glyphicon-remove"></i> 关闭本页面</a>&nbsp;&nbsp;关闭本页面后，缺省的首页为"业务系统登陆"页面。
	        		</div>
					   
					   <h3> EEPlat是最具扩展性、最强大的企业信息系统在线开发平台。EEPlat拥有领先的元模型体系，提供元数据驱动、在线配置的开发模式，可以实现细粒度业务的灵活定制。
					   </h3>
					   
					   <h3>EEPlat提供了多租户的管理，实现了多租户数据及逻辑的隔离，解决了多租户应用在功能、界面等方面无法满足不同租户个性化要求等问题。EEPlat可以大幅度得提高生产率，可帮助实现低成本、高质量、易扩展的跨越云计算和传统计算的信息管理系统。
						</h3>
				...
				<div class="col-md-offset-1 col-md-3  col-xs-12">
					...
					<div class="well">
						...
						<h3>文档</h3>
						<ul>
							<li><a href="web/helper/firstprj.htm">第一个工程</a></li>
